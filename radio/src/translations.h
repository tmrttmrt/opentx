...
#if defined(CPUESP32)
#if defined(MULTIMODULE)
  #define OFS_MULTI_PROTOCOLS   (OFS_VPERSISTENT + sizeof(TR_VPERSISTENT))
  #define OFS_VPREC           (OFS_MULTI_PROTOCOLS + sizeof(TR_MULTI_PROTOCOLS))
#else
  #define OFS_VPREC           (OFS_VPERSISTENT + sizeof(TR_VPERSISTENT))
#endif
#if defined(BLUETOOTH)
